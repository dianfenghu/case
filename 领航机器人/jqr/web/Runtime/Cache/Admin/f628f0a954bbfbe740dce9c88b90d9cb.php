...
<![endif]-->
<title>郑州腾翔网站后台管理系统</title>
<meta name="keywords" content="郑州腾翔网站后台管理系统">
<meta name="description" content="郑州腾翔网站后台管理系统">
</head>
<body>
...
<div class="page-container">
    <div id="tab-system" class="HuiTab"> 
        <!--网站LOGO-->
        <div class="tabCon">
            <form class="form form-horizontal" id="form-article-add" action="/Admin/Setting/updateQRcode" method="post" enctype="multipart/form-data">
                <input type="hidden" name="Sid" value="<?php echo ($QRcode[0]['Sid']); ?>">
                <div class="row">
                    <div class="leftw fl">
                        <label class="form-label">二维码：</label>
                    </div>
                    <div class="rightcon fl">
                        <?php if($QRcode[0]['QRcode']): ?><img src="/Public/Uploads/QRcode/<?php echo ($QRcode[0]['QRcode']); ?>"  width="100" height="100"/>
                            <?php else: ?>
                            <p>您暂时没有上传二维码</p><?php endif; ?>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="row">
                    <div class="leftw fl">
                        <label class="form-label">上传新的二维码：</label>
                    </div>
                    <div class="rightcon fl"> <span class="btn-upload form-group">
                        ...
                        <input type="file" multiple name="QRcode" class="input-file">
                        </span> </div>
                    <div class="clear"></div>
                </div>
                <div class="row">
