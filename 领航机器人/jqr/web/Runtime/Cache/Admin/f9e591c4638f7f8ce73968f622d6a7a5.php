...
<body>
	<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span> 文件管理 
		<span class="c-gray en">&gt;</span> 文件列表
		<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<div class="page-container">
		<div class="text-c">
			<form class="Huiform" method="post" action="/Admin/File/insertFiles" target="_self" enctype="multipart/form-data" id="myform">
				<input type="text" placeholder="文件名称" value="" class="input-text" style="width:120px" name="Name" id="Name">
				...
				<tbody>
					<?php if(is_array($Links)): $i = 0; $__LIST__ = $Links;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Links): $mod = ($i % 2 );++$i;?><tr class="text-c">
							...
							<td class="f-14 product-brand-manage">
								...
								<a style="text-decoration:none" class="ml-5" href="/Admin/File/delLinks/Lid/<?php echo ($Links["Fid"]); ?>" title="删除"><i class="Hui-iconfont">&#xe6e2; 删除</i></a>
							</td>
